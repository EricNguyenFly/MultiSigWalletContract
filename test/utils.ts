...
export function getParamFromTxEvent(transaction: ContractReceipt, paramName: string, contractFactory: any, eventName: string) {
  ...
  if (!logs[0].args || logs[0].args.length === 0) return;
